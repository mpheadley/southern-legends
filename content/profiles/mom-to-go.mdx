...
<ArticleImage
  src="/images/profiles/jean-ellison/jsu-encore-performance-2007-upscaled.webp"
  alt="Jean Ellison and Matt Headley performing in JSU Encore Show Choir, 2007"
  caption="Encore! Show Choir, Jacksonville State University, 2007. Jean is center. I'm on the right. Photo by Olivia Fadul."
  layout="full"
  width={2416}
  height={1812}
/>
...
<ArticleImage
  ...
  caption="Backstage after Hansel and Gretel, JSU, January 2007. Photo by Meg Griffin."
  layout="full"
  width={2416}
  height={1808}
/>
